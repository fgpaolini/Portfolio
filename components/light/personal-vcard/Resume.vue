<template>
  <div class="resume section-padding bord-thin-top" data-scroll-index="2">
    <div class="sec-head mb-50">
      <h3>Working <span class="fw-200">Experience</span></h3>
    </div>
    <div>
      <div class="resume-clumn">
        <div class="items mb-40">
          ...
          <h5>
            Art Director
            <span class="fw-200 ml-15">[ at UiCamp ]</span>
          </h5>
          <div class="row">
            <div class="col-md-10">
              <p class="mt-15 fz-14">
        ...
        <div class="items mb-40">
          ...
          <h5>
            Front-end Developer
            <span class="fw-200 ml-15">[ at Envato Market ]</span>
          </h5>
          <div class="row">
            <div class="col-md-10">
              <p class="mt-15 fz-14">
        ...
        <div class="items">
          ...
          <h5>
            ...
            <span class="fw-200 ml-15">[ US RMIT University ]</span>
          </h5>
          <div class="row">
            <div class="col-md-10">
              <p class="mt-15 fz-14">
